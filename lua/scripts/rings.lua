...
clock_m = {
    ...
    graduation_radius=113,
    graduation_thickness=10,        graduation_mark_thickness=6,
    graduation_unit_angle=30,
    graduation_fg_colour=0xFFFFFF, graduation_fg_alpha=0.3,
    },
}
...
{
    name='fs_used_perc',           arg='/run/',                     max_value=100,
    x=906,                          y=488,
    graph_radius=65,
    graph_thickness=12,
    graph_start_angle=180,
...
{
    name='downspeedf',           arg='wlp2s0b1',                     max_value=100,
    x=730,                          y=488,
    graph_radius=65,
    graph_thickness=20,
    graph_start_angle=180,
...
{
    name='upspeedf',           arg='wlp2s0b1',                     max_value=100,
    x=730,                          y=488,
    graph_radius=40,
    graph_thickness=20,
    graph_start_angle=180,
